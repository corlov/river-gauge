...
----------------------------------
    2) написать полный вариант кода с Флеш памятью и т.д.

----------------------------------
    6) отдать схему посмотреть в Орел, затем отдать на завод

----------------------------------
    7) учесть особенность схемы 5110 и резистор скорее всего поставить на 1мОм, кручение не очень помогает резистора подстроечного

    8) продумать герморазьем
