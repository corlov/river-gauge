07.02.2026
    ...
    6) поставить амперметер- будет ли с ним работать - может сгореть к херам..?
    7) отправлять данные в центр попробовать (нужно деньги на сим карту и или упросить посылку и принимать на сервере в Германии данные либо оплатить сервер)
